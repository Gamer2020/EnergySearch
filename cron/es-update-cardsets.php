...
function import_card_sets()
{
    ...
    foreach ($sets as $model) {
        ...
        $stmt->execute([
            ...
            'total' => $set['total'],
            'unlimited' => returnWordIfNull($set['legalities']['unlimited'], "NO"),
            'standard' => returnWordIfNull($set['legalities']['standard'], "NO"),
            'expanded' => returnWordIfNull($set['legalities']['expanded'], "NO"),
