<footer>
    <p>&copy;
        <?php echo date("Y"); ?> Energy Search. All rights reserved.
        <br>Pokémon characters, images, and card images belong to Pokémon USA, Inc. and Nintendo. This website or it's
