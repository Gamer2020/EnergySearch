<h2>Most Upvoted Decks - This Month</h2>
<?php

global $pdo;

$stmt = $pdo->prepare("SELECT * from es_decks where visible = 'YES' ORDER BY monthly_upvotes DESC LIMIT 5");
$stmt->execute();
...
if ($row_count > 0)
{
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC))
    {
        ...
        echo "<br>Upvotes this month: " . ($row['monthly_upvotes']);
