<h2>Deck Matches - By Name</h2>
<?php

global $pdo;

$stmt = $pdo->prepare("SELECT * from es_decks where visible = 'YES' AND cards LIKE :cardname ORDER BY id DESC LIMIT 10");
$stmt->bindValue(':cardname', '%' . $card['name'] . '%', PDO::PARAM_STR);
$stmt->execute();
